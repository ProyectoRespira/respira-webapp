...
- **Affected component:** Which part of the project is affected (frontend, backend, etc.)
...
4. Keep vulnerability details confidential until we publicly acknowledge the issue
