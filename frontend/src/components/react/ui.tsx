// Shared presentational pieces for React islands.
//
...
// same uppercase-label treatment.
//
// Written for the institutional dashboard (RES-328) and kept in `institution/`
// until something outside it needed them; the public data export (RES-439) did,
// so they moved here. `institution/ui.tsx` re-exports them, which is why the
// panel's own imports still read `./ui`.
//
// Nothing here may reach for a session, a store or a translation: these are
// used on both sides of the login, and a component that assumed an institution
// would break the public pages.
