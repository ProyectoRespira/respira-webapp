...
export default function Modal({
  ...
  return (
    <>
      {showModal ? (
        <>
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none overscroll-contain">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-base outline-none focus:outline-none ">
                {renderHeader && (
                  <div className="flex flex-row justify-between p-5 rounded-t items-center  flex-grow ">
                    <h3 className="text-xl font-serif mr-12">{title || ""}</h3>
                    <button
