    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('run_date', models.DateTimeField(blank=True, db_column='as_of', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.regions')),
            ],
            options={
                'db_table': 'stations',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_utc', models.DateTimeField(blank=True, db_column='date_localtime', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('forecasts_6h', models.JSONField(blank=True, db_column='forecast_6h', null=True)),
                ('forecasts_12h', models.JSONField(blank=True, db_column='forecast_12h', null=True)),
