    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "run_date",
                    models.DateTimeField(blank=True, db_column="as_of", null=True),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "has_pattern_station",
                    models.BooleanField(db_column="has_pattern_data", default=False),
                ),
            ],
            options={
                "db_table": "regions",
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, db_column="date_localtime", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "region",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.DO_NOTHING, to="api.regions"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "forecasts_6h",
                    models.JSONField(blank=True, db_column="forecast_6h", null=True),
                ),
                (
                    "forecasts_12h",
                    models.JSONField(blank=True, db_column="forecast_12h", null=True),
                ),
